    ...
    <div className="bg-white px-6 pt-8 pb-16 lg:px-8">
      <div className="mx-auto max-w-3xl text-base leading-7 text-gray-700">
        ...
        <div className="mt-10 max-w-2xl">
          ...
          Наше заведение - это место, где вы можете насладиться теплой атмосферой и уютом, будь то в ресторане или у себя дома благодаря нашей доставке. Мы стремимся к тому, чтобы каждый посетитель чувствовал себя как дома и получил незабываемый опыт.
          </p>
